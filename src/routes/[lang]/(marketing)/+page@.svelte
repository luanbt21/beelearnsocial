	...
	<section class="bg-white dark:bg-gray-900">
		<div class="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
			...
			<div class="hidden lg:mt-0 lg:col-span-4 lg:flex">
				<img src="/Demo-amico.svg" alt="mockup" />
			</div>
		</div>
	</section>
		...
		<div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
			...
			<div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
				<div>
					...
					<h3 class="mb-2 text-xl font-bold dark:text-white">{$LL.spacedRepetition()}</h3>
					<p class="text-gray-500 dark:text-gray-400">
						{$LL.spacedRepetitionDetail()}
					</p>
				</div>
				<div>
					<div
					...
					<h3 class="mb-2 text-xl font-bold dark:text-white">{$LL.microlearning()}</h3>
					<p class="text-gray-500 dark:text-gray-400">
						{$LL.microlearningDetail()}
					</p>
				</div>
				<div>
					<div
					...
					<h3 class="mb-2 text-xl font-bold dark:text-white">{$LL.landingCollection()}</h3>
					<p class="text-gray-500 dark:text-gray-400">
						{$LL.landingCollectionDetail()}
					</p>
				</div>
			</div>
		</div>
	...
	<section class="bg-white dark:bg-gray-900">
		...
		>
			<div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
				...
				<p class="mb-4">
					{$LL.landingAwardDetail()}
				</p>
				<p>
					{$LL.landingUserResearch()}.
				</p>
			</div>
		...
		<div class="mx-auto max-w-screen-xl">
				...
				<div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
					<div>
						...
						<ul class="text-gray-600 dark:text-gray-400">
							<li class="mb-4">
								<a href="https://beelearn.social" class="hover:underline">BeeLeanSocial</a>
							</li>
							<li>
			...
			<div class="sm:flex sm:items-center sm:justify-between">
				<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">
					© 2022 <a href="https://beelearn.social" class="hover:underline">BeeLearn™</a>
					. All Rights Reserved.
				</span>
